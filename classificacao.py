...
################## Pré-processamento ###################
# Coleta e Integração
iris = load_iris() #retorna um objeto onde podemos acessar as caracteristicas das flores pelo atributo data e os rotulos, ou classes das flores, pelo atributo target
